...
abstract class BasesfGuardForgotPasswordActions extends sfActions
{
  ...
  public function executeEnviado($request)
  {
    ...
    if ($request->isMethod('post'))
    {
      ...
      if ($this->form->isValid())
      {
        ...
        $message = Swift_Message::newInstance()
          ->setFrom(sfConfig::get('app_sf_guard_plugin_default_from_email', 'noexiste@vwamarok.com.ar'))
          ->setTo($this->form->user->email_address)
          ->setSubject('Recuperacion de password de Amarok Prensa')
        ...
        $this->forward('sfGuardForgotPassword', 'enviado');
      } else {
